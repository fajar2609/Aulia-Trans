...
<html>
<head>
<title>ATW | Detail Transportasi</title>
...
<div class="selectroom">
	<div class="container">	
		  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
					...
					<div><strong>Notes</strong>:<div>Pembayaran Bisa Dilakukan Dengan Cash Atau Melalui Rekening Berikut : </div></div>
					<div>BCA : 6299962456 A\N Abdul Aziz</div>
					<div>BRI : 23881239978934 A\N Abdul Aziz</div>
					<div>QRIS : </div>
					<img 
						src=""
						width="200px"
