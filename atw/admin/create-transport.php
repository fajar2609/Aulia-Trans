...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Buat Transportasi </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="trans" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="transname" id="transname" placeholder="Create Transport" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Tipe Transportasi</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="transtype" id="transtype" placeholder="Tipe Transportasi" required>
									</div>
								</div>
...
<!-- <div class="form-group"> -->
									...
									<!-- <div class="col-sm-8"> -->
										<!-- <input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price is IDR" required> -->
									<!-- </div> -->
								<!-- </div> -->
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="transfeatures" id="transfeatures" placeholder="Fasilitas" required>
									</div>
								</div>		
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea class="form-control" rows="5" cols="50" name="transdetails" id="transdetails" placeholder="Detail Transportasi" required></textarea> 
									</div>
								</div>															
<div class="form-group">
