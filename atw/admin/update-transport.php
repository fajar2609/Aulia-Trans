...
<div class="col-sm-8">
<img src="transimages/<?php echo htmlentities($result->TransImage);?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid=<?php echo htmlentities($result->TransId);?>">Change Image</a>
</div>
</div>
