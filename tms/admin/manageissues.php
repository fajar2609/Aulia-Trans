...
<html>
<head>
<title>ATW | Admin manage Issues</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Mengelola Masalah</li>
            </ol>
...
<td><a href="javascript:void(0);" onClick="popUpWindow('updateissue.php?iid=<?php echo ($result->id);?>');" class="btn btn-primary btn-block">Lihat </a>

<a href="manageissues.php?action=delete&&id=<?php echo $result->id;?>" onclick="return confirm('Do you really want to delete?')" class="btn btn-danger btn-block">Hapus</a>
</td>
