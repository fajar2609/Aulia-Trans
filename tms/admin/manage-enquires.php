...
<html>
<head>
<title>ATW | Admin manage Bookings</title>
...
{
	?><td>Baca | 	<a href="manage-enquires.php?action=delete&&id=<?php echo $result->id;?>" onclick="return confirm('Do you really want to delete?')" style="color:red">Hapus</a></td>
<?php } else {?>

<td><a href="manage-enquires.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to read')" >Tertunda</a> | 

	<a href="manage-enquires.php?action=delete&&id=<?php echo $result->id;?>" onclick="return confirm('Do you really want to delete?')" style="color:red">Hapus</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
